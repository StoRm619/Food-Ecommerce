...
const Cart = ({ cart, handleEmptyCart, handleRemoveFromCart, handleUpdateCartQty }) => {
    ...
    const EmptyCart = () => (
        <Typography variant="subtitle1">Shopping Cart is Empty
            <Link to="/" className={classes.link}>Get some food</Link>
        </Typography>
        ...
        <>
            ...
            <div className={classes.cardDetails}>
                ...
                <div>
                    ...
                    <Button component={Link} to='/checkout' toclassName={classes.checkoutButton} size='large' type='button' variant="contained" color='primary'>
                        Checkout
                    </Button>
                </div>
            </div>
